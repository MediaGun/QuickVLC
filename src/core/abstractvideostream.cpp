...
{
    libvlc_video_set_output_callbacks(player->core(), libvlc_video_engine_opengl, setup_cb, cleanup_cb, nullptr,
        resize_cb, swap_cb, make_current_cb, get_proc_address_cb, nullptr, nullptr, this);
}
